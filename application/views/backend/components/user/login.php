<html lang="">
    ...
    <body>
        <div class="container khung">
            <div class="title">
                <h2 class="text-center" style="color:#066d3e">Danh Vinh Shop</h2>
            </div>
            <hr>
            <div class="myform">
        ...
        <nav class="navbar navbar-fixed-bottom" role="navigation">
            <div class="container">
               <h5 class="text-center">Copyright © 2023 <a href="#" style="color:red">DANH VINH SHOP</a>. All rights reserved.</h5>
            </div>
        </nav>
        <!-- jQuery -->
