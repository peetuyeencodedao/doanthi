			...
			<div class="col-md-12 col-lg-12">
				<div class="navbar-header">
					...
					<div class="icon-cart-mobile hidden-md hidden-lg">
						<a href="gio-hang">
							<i class="fa fa-shopping-cart" aria-hidden="true" style="color: #066d3e; font-size: 17px;"></i>
							<span>(<?php  
                ...
                <div id="navbar" class="collapse navbar-collapse" style="color: #066d3e">
                	<ul class="nav navbar navbar-nav" id="nav1">
                		<li><a href="/"><i class="bi bi-house"></i>Trang chủ</a></li>
