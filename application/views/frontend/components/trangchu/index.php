...
<div class="container" style="margin-bottom: 20px;">
    <div class="owl-carousel owl-carousel-product owl-theme" style="border: 1px solid #066d3e;">
        <?php 
    ...
    <div class="container">
        <div class="row-p">
            <div class="text-center">
                <h2 class="sectin-title title title-blue" style="color: #066d3e">Tin tức công nghệ</h2>
            </div>
        </div>
        <div class="blog-content">
            ...
            foreach ($listBaiViet as $rowPost) :?>
                <div class="col-xs-12 col-12 col-sm-6 col-md-4 col-lg-4" style="margin: 0px;">
                    <div class="latest">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12 text-center m-b-xs-10">
                        <div class="service_item">
                            ...
                            <div class="description_icon">
                                <span class="large-text" style="color: #066d3e">
                                    Miễn phí giao hàng
                                </span>
                                <span class="small-text style="color: #066d3e"">
                                    Cho hóa đơn từ 1,000,000đ trở lên
                                </span>
                            </div>
                        </div>
                    </div>
