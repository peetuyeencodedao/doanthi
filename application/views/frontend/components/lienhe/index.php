		...
		<div class="col-md-4 col-12">
			...
			<ul class="list-unstyled">
				<li class="clearfix">
					...
					<span style="color: black">Nguyễn Viết Xuân - Hưng Dũng - TP Vinh</span><br>
				</li>
				<li class="clearfix">
					<i class="fa fa-phone fa-1x" style="color:#0f9ed8;padding: 20px;  "></i>
					<span style="color: black">Hotline: 0366765726</span>
				</li>
				<li class="clearfix">
					<i class="fa fa-envelope fa-1x " style="color:#0f9ed8; padding: 20px; "></i>
					<span style="color: black"><a href="mailto:alitrumcuoi@gmail.com">alitrumcuoi@gmail.com</span>
				</li>
			</ul>
		</div>
